...
4. shop_reg.php               webpage with registration form of the site
5. add.php                    php script for adding one item to the cart
6. add_product.php            php script for adding a product to the shopping cart
7. confirm_order.php          webpage with successful notification of created order and php script of order creation
8. delete_from_basket.php     php script for removing an item from the shopping cart
9. remove.php                 php script for removing one item from the shopping cart
