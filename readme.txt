...
3. shop_login.php             webpage with a login form on the site
4. shop_reg.php               webpage with the registration form of the site
...
9. remove.php                 php script for removing one item from the basket
